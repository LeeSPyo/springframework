...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <c:if test="${sLevel <= 4}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        ...
	        <a href="${ctp}/study/mail/mailForm" class="w3-bar-item w3-button">Mail연습</a>
    ...
    <c:if test="${empty sLevel}"><a href="${ctp}/member/memLogin" class="w3-bar-item w3-button w3-padding-large w3-hide-small w3-right">Login</a></c:if>
    <c:if test="${!empty sLevel}"><a href="${ctp}/member/memLogout" class="w3-bar-item w3-button w3-padding-large w3-hide-small w3-right">Logout</a></c:if>

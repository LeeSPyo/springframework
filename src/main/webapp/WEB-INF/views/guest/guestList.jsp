...
<div class="text-center">
  <ul class="pagination justify-content-center">
	  <c:if test="${pag > 1}">
	    <li class="page-item"><a href="guestList?pag=1" class="page-link text-secondary"><i class="fa-solid fa-angles-left"></i></a></li>
	  </c:if>
	  <c:if test="${curBlock > 0}">
	    <li class="page-item"><a href="guestList?pag=${(curBlock-1)*blockSize + 1}" class="page-link text-secondary"><i class="fa-solid fa-angle-left"></i></a></li>
	  </c:if>
	  ...
	  <c:if test="${curBlock < lastBlock}">
	    <li class="page-item"><a href="guestList?pag=${(curBlock+1)*blockSize + 1}" class="page-link text-secondary"><i class="fa-solid fa-angle-right"></i></a></li>
	  </c:if>
	  <c:if test="${pag != totPage}">
	    <li class="page-item"><a href="guestList?pag=${totPage}" class="page-link text-secondary"><i class="fa-solid fa-angles-right"></i></a></li>
	  </c:if>
  </ul>
</div>
<!-- 블록 페이징 처리 끝 -->
